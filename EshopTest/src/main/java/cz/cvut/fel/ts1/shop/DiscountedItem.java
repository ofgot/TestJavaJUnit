...
public class DiscountedItem extends Item {
    ...
    public DiscountedItem(int id, String name, double price, String category, int discount, Date discountFrom, Date discountTo) {
    ...
    public DiscountedItem(int id, String name, double price, String category, int discount, String discountFrom, String discountTo)  {
        super(id, name, price, category);
